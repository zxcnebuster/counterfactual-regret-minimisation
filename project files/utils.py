...
def counterfactual_reach_prob(reach_prob_map, player):
    return reduce(
        lambda x, y: x * y,
...
class EmptyPolicyPrinter(PolicyPrinter):
    def print_profile(self, *args, **kwargs):
        return ""

    def print_policy(self, *args, **kwargs):
        return ""
...
def make_uniform_policy(root_state_or_game):
